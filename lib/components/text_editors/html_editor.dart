            ...
            child: AlertDialog(
              actions: [
                ...
                TextButton(
                  ...
                  child: Text(context.localized.add),
                ),
              ],
                  ...
                  Form(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: context.localized.enter,
                        label: Text(context.localized.url),
                      ...
                      validator: ((value) {
                        if (value!.isEmpty) {
                          return context.localized.empty_value;
                        }
                        String? videoId = getIdFromUrl(youtubeCtlr.text);
                        if (videoId == null) {
                          return context.localized.invalid_video_id;
                        }
                        return null;
                      }),
                    ),
        ...
        builder: ((context) {
          return PointerInterceptor(
            child: AlertDialog(
              ...
              title: Text(context.localized.image_url),
              content: Form(
                key: formKey,
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  ...
                  children: [
                    TextFormField(
                      ...
                      validator: ((value) {
                        ...
                        if (!validURL) return context.localized.invalid_url;
                        return null;
                      }),
                    )
                  ],
        ...
        builder: ((context) {
          return PointerInterceptor(
            child: AlertDialog(
              ...
              title: Text(context.localized.network_video_url),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
