    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text('Вопросы *', style: Theme.of(context).textTheme.titleLarge),
            TextButton.icon(
              icon: const Icon(Icons.add),
              label: Text(context.localized.add),
              style: IconButton.styleFrom(
                  backgroundColor: Colors.grey.shade300,
                  foregroundColor: Theme.of(context).primaryColor),
              onPressed: () {
                CustomDialogs.openResponsiveDialog(context,
                    widget: const QuizForm(), verticalPaddingPercentage: 0.03);
              },
            ),
          ],
        ),
        ...
        questions.isEmpty
            ? Padding(
                ...
                child: Center(child: Text(context.localized.no_items)),
              )
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                              '${context.localized.correct_answer}: ${q.options[q.correctAnswerIndex]}'),
                        ],
                      ),
                          ...
                          CustomButtons.circleButton(
                            ...
                            onPressed: () {
                              CustomDialogs.openResponsiveDialog(
                                context,
                                widget:
                                    QuizForm(question: q, questionIndex: index),
