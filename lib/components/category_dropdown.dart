...
class CategoryDropdown extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String? selectedId = selectedCategoryId == null
        ? null
        : categories
                .where((element) => element.id == selectedCategoryId)
                .isEmpty
            ? null
            : selectedCategoryId;
    ...
    return Column(
      ...
      children: [
        Text(
          title ?? '${context.localized.category} *',
            ...
            children: [
                ...
                child: DropdownButtonFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return context.localized.required;
                    }
                    return null;
                  },
                  onChanged: (dynamic value) => onChanged(value),
                  value: selectedId,
                  hint: Text(context.localized.select),
              ...
              Visibility(
                ...
                child: IconButton(
                  ...
                  tooltip: context.localized.clear_selection,
