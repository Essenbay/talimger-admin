...
mixin ReviewMixin {
  Widget buildReviews(
    ...
    return FirestoreQueryBuilder(
      ...
      builder: (context, snapshot, _) {
        ...
        return _reviewList(context,
            snapshot: snapshot, ref: ref, isAuthorCourses: isAuthorCourses);
      },
    );
  }
  ...
  ListTile _buildListItem(BuildContext context, Review review, WidgetRef ref,
      bool isAuthorCourses) {
    return ListTile(
      ...
      leading: UserMixin.getUserImageByUrl(
          imageUrl: review.reviewUser.imageUrl, radius: 40, iconSize: 20),
      subtitle: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(AppService.getDateTime(context, review.createdAt)),
            ],
          ),
        ],
      ),
      trailing: Visibility(
          ...
          child: CustomButtons.circleButton(context,
              icon: Icons.delete,
              onPressed: () => _onDelete(context, review, ref))),
    );
  }
  ...
  void _onDelete(context, Review review, WidgetRef ref) async {
    ...
    CustomDialogs.openActionDialog(
      ...
      message:
          'Do you want to delete this user review?\nWarning: This can not be undone.',
      onAction: () async {
        if (UserMixin.hasAdminAccess(ref.read(userDataProvider))) {
          ...
          final double avarageRating =
              await FirebaseService().getCourseAverageRating(review.courseId);
          await FirebaseService()
              .saveCourseRating(review.courseId, avarageRating);
