...
import 'package:increatorkz_admin/forms/change_password.dart';
import 'package:increatorkz_admin/forms/edit_profile.dart';
  ...
  PopupMenuButton buildUserMenuButton(
    ...
    return PopupMenuButton(
      ...
      onSelected: (value) async {
        //Edit Profile
        if (value == userMenus(context).keys.elementAt(0)) {
          CustomDialogs.openResponsiveDialog(context,
              widget: EditProfile(user: user!));
        }

        //Logout
        if (value == userMenus(context).keys.elementAt(2)) {
        ...
        //chnage Password
        if (value == userMenus(context).keys.elementAt(1)) {
