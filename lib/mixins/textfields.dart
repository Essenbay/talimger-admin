      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            validator: (value) {
              if (validationRequired && value!.isEmpty)
                return context.localized.empty_value;
              if (urlValidationRequired && !AppService.isURLValid(value!)) {
                return context.localized.invalid_url;
              }
              return null;
            },
              ...
              suffixIcon: Row(
                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: IconButton(
                      tooltip: context.localized.select,
