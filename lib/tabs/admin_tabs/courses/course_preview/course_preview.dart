...
import 'package:increatorkz_admin/tabs/admin_tabs/courses/course_preview/course_description.dart';
import 'package:increatorkz_admin/tabs/admin_tabs/courses/course_preview/course_info.dart';
import 'package:increatorkz_admin/tabs/admin_tabs/courses/course_preview/learnings.dart';
import 'package:increatorkz_admin/tabs/admin_tabs/courses/course_preview/requirements.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(context.localized.preview),
        leading: IconButton(
          ...
          children: [
            Stack(
              ...
              children: [
                ...
                Visibility(
                  visible:
                      course.videoUrl != null && course.videoUrl!.isNotEmpty,
                  child: const Align(
                    alignment: Alignment.center,
                    child: Icon(
                      LineIcons.play,
