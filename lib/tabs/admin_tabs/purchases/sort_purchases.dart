...
//         return sortByPurchases(context).entries.map((e) {
...
//         ref
//             .read(sortByPurchasesTextProvider.notifier)
//             .update((state) => sortByPurchases(context)[value].toString());
...
//         if (value == 'active') {
//           final newQuery =
//               colRef.where('expire_at', isGreaterThanOrEqualTo: DateTime.now());
//           qureryProvider.update((state) => newQuery);
//         }
//         if (value == 'expired') {
//           final newQuery =
//               colRef.where('expire_at', isLessThanOrEqualTo: DateTime.now());
//           qureryProvider.update((state) => newQuery);
//         }
//         if (value == 'android') {
