...
import 'package:increatorkz_admin/tabs/admin_tabs/dashboard/empty_bar_chart.dart';
          ...
          children: <Widget>[
            Row(
              ...
              children: [
                ...
                Text(
                  context.localized.news_user_registration,
            ...
            DefaultTabController(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(
                    child: Text(context.localized.last_days(7)),
                  ),
                  Tab(
                    child: Text(context.localized.last_days(30)),
                  )
                ],
              ),
            ),
    ...
    return BarTouchTooltipData(
      ...
      getTooltipItem: (groupData, groupIndex, rod, rodIndex) {
        ...
        return BarTooltipItem(
            '${rod.toY} ${context.localized.users}',
            const TextStyle(
