//TODO: Implement purshace statistic
...
//                 ),
//                 Text(
//                   context.localized.sub_purchases,
...
//                   if (index == 0) {
//                     ref
//                         .read(purchaseStatsDaysCount.notifier)
//                         .update((state) => 7);
...
//                 tabs: [
//                   Tab(child: Text(context.localized.last_days(7))),
//                   Tab(child: Text(context.localized.last_days(30)))
//                 ],
//               ),
//             ),
...
//                             touchTooltipData:
//                                 _getTouchData(context, purchaseStats)),
...
//                                     _bottomTitles(context, value, ref),
//                               ),
//                             )),
//                       ),
//                     );
...
//   _bottomTitles(BuildContext context, double value, ref) {
//     String title = context.localized.purshases;
...
//       BuildContext context, List<ChartModel> purchaseStats) {
...
//       BuildContext context, purchaseStats) {
