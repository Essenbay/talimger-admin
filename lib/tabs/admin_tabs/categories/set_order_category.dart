...
final filteredCategoriesProvider =
    StateProvider.autoDispose<List<Category>>((ref) => []);
...
class _SetCategoryOrderState extends ConsumerState<SetCategoryOrder> {
    ...
    return Scaffold(
      ...
      body: ReorderableListView.builder(
        ...
        onReorder: (oldIndex, newIndex) =>
            _onReorder(oldIndex, newIndex, categories, ref),
  ...
  void _onReorder(
      int oldIndex, int newIndex, List<Category> categories, WidgetRef ref) {
  ...
  Future _handleUpdate(BuildContext context, WidgetRef ref,
