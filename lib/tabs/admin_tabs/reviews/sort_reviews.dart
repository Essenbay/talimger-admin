  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton(
      ...
      itemBuilder: (BuildContext context) {
        return sortByReviews(context).entries.map((e) {
      ...
      onSelected: (dynamic value) {
        ref
            .read(sortByReviewTextProvider.notifier)
            .update((state) => sortByReviews(context)[value].toString());
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        ref
                            .read(sortByReviewTextProvider.notifier)
                            .update((state) => course.name);
                        final newQuery =
                            colRef.where('course_id', isEqualTo: course.id);
                        ref
                            .read(reviewsQueryprovider.notifier)
