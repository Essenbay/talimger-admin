...
import 'package:increatorkz_admin/models/author_info.dart';
...
class _EditProfileState extends ConsumerState<EditProfile>
  ...
  Future<String?> _getImageUrl() async {
    if (_selectedImage != null) {
      final String? imageUrl = await FirebaseService()
          .uploadImageToFirebaseHosting(_selectedImage!, 'user_images');
      return imageUrl;
    } else {
  ...
  _handleSubmit() async {
    if (formKey.currentState!.validate()) {
      ...
      if (imageUrl != widget.user.imageUrl && widget.user.imageUrl != null) {
      ...
      btnController.reset();
      if (!mounted) return;
      CustomDialogs.openInfoDialog(context, context.localized.update, '');
    }
  }

  Future _updateDatabase(String? imageUrl) async {
    await FirebaseService()
        .updateUserProfile(widget.user, _prepareData(imageUrl));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: 30,
        title: Text(
          context.localized.edit_profile,
            ...
            children: [
              ...
              Padding(
                ...
                child: buildTextField(
                  context,
                  controller: nameCtlr,
                  hint: context.localized.name,
                  title: '${context.localized.name}*',
              ...
              Padding(
                ...
                child: buildTextField(context,
                    controller: jobTitleCtlr,
                    hint: context.localized.work_title,
                    title: context.localized.work_title,
                    hasImageUpload: false,
              ...
              Padding(
                ...
                child: buildTextField(context,
                    controller: bioCtlr,
                    hint: context.localized.bio,
                    title: context.localized.bio,
                    hasImageUpload: false,
                    minLines: 2,
                    maxLines: null,
                    validationRequired: false),
              ...
              Padding(
                ...
                child: buildTextField(context,
                    ...
                    title: context.localized.website,
                    hasImageUpload: false,
                    validationRequired: false),
              ),
              Padding(
